        ...
        <div class="w-3/4">
            ...
            <div class="mb-6">
                <div class="flex items-end justify-between mb-2">
                    ...
                    <!-- Edit and Delete-->
                     <div v-if="canModify" class="pl-5 flex items-center gap-4">
                        <Link
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center mb-2 gap-2">
                    ...
                    <p>Listed by:</p>
                    <Link :href="route('home', { user_id: listing.user.id })" class="text-link">
                       {{ listing.user.name }}
                    </Link>
                </div>
            </div>
            ...
            <div v-if="listing.tags" class="mb-6">
                ...
                <div class="flex items-center gap-3">
                    <div v-for="tag in listing.tags.split(',')" :key="tag">
                        ...
                        <!-- Added redirect to home with filter based on chosen tag -->
                        <Link
                            :href="route('home', { tag })"
